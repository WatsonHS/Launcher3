...
public class InfoDropTarget extends ButtonDropTarget {
    ...
    protected void onFinishInflate() {
        ...
        // Get the hover color
        mHoverColor = getResources().getColor(com.watsonh.fractlauncher.R.color.info_target_hover_tint);

        setDrawable(com.watsonh.fractlauncher.R.drawable.ic_info_launcher);
    }
