...
package com.watsonh.fractlauncher.util;
...
import com.watsonh.fractlauncher.LauncherFiles;
import com.watsonh.fractlauncher.MainThreadExecutor;
...
public class ManagedProfileHeuristic {
    ...
    private void finalizeWorkFolder() {
        ...
        if (mPrefs.contains(folderIdKey)) {
            ...
            workFolder.title = mContext.getText(com.watsonh.fractlauncher.R.string.work_folder_name);
