...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    protected void onFinishInflate() {
        ...
        mDropTargetBar = findViewById(com.watsonh.fractlauncher.R.id.drag_target_bar);
        mInfoDropTarget = (ButtonDropTarget) mDropTargetBar.findViewById(com.watsonh.fractlauncher.R.id.info_target_text);
        mDeleteDropTarget = (ButtonDropTarget) mDropTargetBar.findViewById(com.watsonh.fractlauncher.R.id.delete_target_text);
        mUninstallDropTarget = (ButtonDropTarget) mDropTargetBar.findViewById(com.watsonh.fractlauncher.R.id.uninstall_target_text);
