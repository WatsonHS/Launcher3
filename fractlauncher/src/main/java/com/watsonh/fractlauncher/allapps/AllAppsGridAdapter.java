 ...
 */
package com.watsonh.fractlauncher.allapps;
...
import com.watsonh.fractlauncher.BubbleTextView;
import com.watsonh.fractlauncher.Launcher;
import com.watsonh.fractlauncher.Utilities;
...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    public AllAppsGridAdapter(Launcher launcher, AlphabeticalAppsList apps,
        ...
        mLauncher = launcher;
        mApps = apps;
        mEmptySearchMessage = res.getString(com.watsonh.fractlauncher.R.string.all_apps_loading_message);
        ...
        mSectionNamesMargin = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.all_apps_grid_view_start_margin);
        mSectionHeaderOffset = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.all_apps_grid_section_y_offset);

        mSectionTextPaint = new Paint();
        mSectionTextPaint.setTextSize(res.getDimensionPixelSize(
                com.watsonh.fractlauncher.R.dimen.all_apps_grid_section_text_size));
        mSectionTextPaint.setColor(res.getColor(com.watsonh.fractlauncher.R.color.all_apps_grid_section_text_color));
        ...
        mPredictionBarDividerOffset =
                (-res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.all_apps_prediction_icon_bottom_padding) +
                        res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.all_apps_icon_top_bottom_padding)) / 2;
    ...
    public void setLastSearchQuery(String query) {
        ...
        String formatStr = res.getString(com.watsonh.fractlauncher.R.string.all_apps_no_search_results);
        mLastSearchQuery = query;
        mEmptySearchMessage = String.format(formatStr, query);
        if (mMarketAppName != null) {
            mMarketSearchMessage = String.format(res.getString(com.watsonh.fractlauncher.R.string.all_apps_search_market_message),
                    mMarketAppName);
        ...
        switch (viewType) {
            ...
            case ICON_VIEW_TYPE: {
                BubbleTextView icon = (BubbleTextView) mLayoutInflater.inflate(
                        com.watsonh.fractlauncher.R.layout.all_apps_icon, parent, false);
            ...
            case PREDICTION_ICON_VIEW_TYPE: {
                BubbleTextView icon = (BubbleTextView) mLayoutInflater.inflate(
                        com.watsonh.fractlauncher.R.layout.all_apps_prediction_bar_icon, parent, false);
                icon.setOnTouchListener(mTouchListener);
                icon.setOnClickListener(mIconClickListener);
                icon.setOnLongClickListener(mIconLongClickListener);
                icon.setLongPressTimeout(ViewConfiguration.get(parent.getContext())
            ...
            case EMPTY_SEARCH_VIEW_TYPE:
                return new ViewHolder(mLayoutInflater.inflate(com.watsonh.fractlauncher.R.layout.all_apps_empty_search,
                        parent, false));
            case SEARCH_MARKET_DIVIDER_VIEW_TYPE:
                return new ViewHolder(mLayoutInflater.inflate(com.watsonh.fractlauncher.R.layout.all_apps_search_market_divider,
                        parent, false));
            case SEARCH_MARKET_VIEW_TYPE:
                View searchMarketView = mLayoutInflater.inflate(com.watsonh.fractlauncher.R.layout.all_apps_search_market,
                        parent, false);
