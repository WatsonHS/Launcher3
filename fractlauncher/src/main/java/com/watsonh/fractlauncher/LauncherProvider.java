...
import com.watsonh.fractlauncher.config.ProviderConfig;
import com.watsonh.fractlauncher.util.ManagedProfileHeuristic;
import com.watsonh.fractlauncher.util.Thunk;
import com.watsonh.fractlauncher.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    public void migrateLauncher2Shortcuts() {
        mOpenHelper.migrateLauncher2Shortcuts(mOpenHelper.getWritableDatabase(),
                Uri.parse(getContext().getString(com.watsonh.fractlauncher.R.string.old_launcher_provider_uri)));
    }
