...
public class ThirdPartyWallpaperPickerListAdapter extends BaseAdapter implements ListAdapter {
    ...
    public ThirdPartyWallpaperPickerListAdapter(Context context) {
        ...
        mIconSize = context.getResources().getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.wallpaperItemIconSize);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = mInflater.inflate(com.watsonh.fractlauncher
