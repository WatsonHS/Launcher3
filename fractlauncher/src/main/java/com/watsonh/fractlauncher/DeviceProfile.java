...
public class DeviceProfile {
    ...
    public DeviceProfile(Context context, InvariantDeviceProfile inv,
        ...
        isTablet = res.getBoolean(com.watsonh.fractlauncher.R.bool.is_tablet);
        isLargeTablet = res.getBoolean(com.watsonh.fractlauncher.R.bool.is_large_tablet);
        isPhone = !isTablet && !isLargeTablet;

        // Some more constants
        transposeLayoutWithOrientation =
                res.getBoolean(com.watsonh.fractlauncher.R.bool.hotseat_transpose_layout_with_orientation);

        ComponentName cn = new ComponentName(context.getPackageName(),
                this.getClass().getName());
        defaultWidgetPadding = AppWidgetHostView.getDefaultPaddingForWidget(context, cn, null);
        edgeMarginPx = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_edge_margin);
        desiredWorkspaceLeftRightMarginPx = 2 * edgeMarginPx;
        pageIndicatorHeightPx =
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_page_indicator_height);
        defaultPageSpacingPx =
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_workspace_page_spacing);
        overviewModeMinIconZoneHeightPx =
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_overview_min_icon_zone_height);
        overviewModeMaxIconZoneHeightPx =
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_overview_max_icon_zone_height);
        overviewModeBarItemWidthPx =
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_overview_bar_item_width);
        overviewModeBarSpacerWidthPx =
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_overview_bar_spacer_width);
        overviewModeIconZoneRatio =
                res.getInteger(com.watsonh.fractlauncher.R.integer.config_dynamic_grid_overview_icon_zone_percentage) / 100f;
        iconDrawablePaddingOriginalPx =
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_icon_drawable_padding);
    ...
    private void computeAllAppsButtonSize(Context context) {
        Resources res = context.getResources();
        float padding = res.getInteger(com.watsonh.fractlauncher.R.integer.config_allAppsButtonPaddingPercent) / 100f;
    ...
    private void updateIconSize(float scale, int drawablePadding, Resources res,
        ...
        searchBarSpaceWidthPx = Math.min(widthPx,
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_search_bar_max_width));
        searchBarSpaceHeightPx = getSearchBarTopOffset()
                + res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dynamic_grid_search_bar_height);
        ...
        final float scaleDps = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.dragViewScale);
    ...
    public void updateAppsViewNumCols(Resources res, int recyclerViewWidth) {
        int appsViewLeftMarginPx =
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.all_apps_grid_view_start_margin);
        int allAppsCellWidthGap =
                res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.all_apps_icon_width_gap);
    ...
    public void layout(Launcher launcher) {
        ...
        if (hasVerticalBarLayout) {
            ...
            LinearLayout targets = (LinearLayout) searchBar.findViewById(com.watsonh.fractlauncher.R.id.drag_target_bar);
        ...
        PagedView workspace = (PagedView) launcher.findViewById(com.watsonh.fractlauncher.R.id.workspace);
        ...
        // Layout the hotseat
        View hotseat = launcher.findViewById(com.watsonh.fractlauncher.R.id.hotseat);
        ...
        if (hasVerticalBarLayout) {
            ...
            hotseat.findViewById(com.watsonh.fractlauncher.R.id.layout).setPadding(0, 2 * edgeMarginPx, 0, 2 * edgeMarginPx);
        } else if (isTablet) {
            ...
            lp.width = LayoutParams.MATCH_PARENT;
            lp.height = hotseatBarHeightPx;
            hotseat.findViewById(com.watsonh.fractlauncher.R.id.layout).setPadding(2 * edgeMarginPx, 0,
                    2 * edgeMarginPx, 0);
        }
        hotseat.setLayoutParams(lp);

        // Layout the page indicators
        View pageIndicator = launcher.findViewById(com.watsonh.fractlauncher.R.id.page_indicator);
