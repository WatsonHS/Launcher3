...
import com.watsonh.fractlauncher.accessibility.LauncherAccessibilityDelegate;
import com.watsonh.fractlauncher.accessibility.OverviewScreenAccessibilityDelegate;
...
import com.watsonh.fractlauncher.widget.PendingAddShortcutInfo;
...
public class Workspace extends PagedView
    ...
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.watsonh.fractlauncher.R.styleable.Workspace, defStyle, 0);
        mSpringLoadedShrinkFactor =
                res.getInteger(com.watsonh.fractlauncher.R.integer.config_workspaceSpringLoadShrinkPercentage) / 100.0f;
        mOverviewModeShrinkFactor =
                res.getInteger(com.watsonh.fractlauncher.R.integer.config_workspaceOverviewShrinkPercentage) / 100f;
        mOriginalDefaultPage = mDefaultPage = a.getInt(com.watsonh.fractlauncher.R.styleable.Workspace_defaultScreen, 1);
        a.recycle();
    ...
    protected void initWorkspace() {
        ...
        setEdgeGlowColor(getResources().getColor(com.watsonh.fractlauncher.R.color.workspace_edge_effect_color));
    }
    ...
    public long insertNewWorkspaceScreen(long screenId, int insertIndex) {
        ...
        CellLayout newScreen = (CellLayout) mLauncher.getLayoutInflater().inflate(
                        com.watsonh.fractlauncher.R.layout.workspace_screen, this, false /* attachToRoot */);
    ...
    public void createCustomContentContainer() {
        CellLayout customScreen = (CellLayout)
                mLauncher.getLayoutInflater().inflate(com.watsonh.fractlauncher.R.layout.workspace_screen, this, false);
    ...
    */
    ...
    private Bitmap createDragOutline(View v, int padding) {
        final int outlineColor = getResources().getColor(com.watsonh.fractlauncher.R.color.outline_color);
    ...
    private void enfoceDragParity(View v, String event, int update, int expectedValue) {
        Object tag = v.getTag(com.watsonh.fractlauncher.R.id.drag_event_parity);
        int value = tag == null ? 0 : (Integer) tag;
        value += update;
        v.setTag(com.watsonh.fractlauncher.R.id.drag_event_parity, value);
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            case LauncherSettings.Favorites.ITEM_TYPE_FOLDER:
                view = FolderIcon.fromXml(com.watsonh.fractlauncher.R.layout.folder_icon, mLauncher, cellLayout,
    ...
    public void animateWidgetDrop(ItemInfo info, CellLayout cellLayout, DragView dragView,
        ...
        final int duration = res.getInteger(com.watsonh.fractlauncher.R.integer.config_dropAnimMaxDuration) - 200;
    ...
    protected PageIndicator.PageMarkerResources getPageIndicatorMarker(int pageIndex) {
        ...
        if (screenId == EXTRA_EMPTY_SCREEN_ID) {
            ...
            if (count > 1) {
                return new PageIndicator.PageMarkerResources(com.watsonh.fractlauncher.R.drawable.ic_pageindicator_current,
                        com.watsonh.fractlauncher.R.drawable.ic_pageindicator_add);
            }
        }
    ...
    protected String getPageIndicatorDescription() {
        String settings = getResources().getString(com.watsonh.fractlauncher.R.string.settings_button_text);
    ...
    private String getPageDescription(int page) {
        ...
        return String.format(getContext().getString(com.watsonh.fractlauncher.R.string.workspace_scroll_format),
