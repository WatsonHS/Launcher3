...
public class ClickShadowView extends View {
    ...
    public ClickShadowView(Context context) {
        ...
        mShadowPadding = getResources().getDimension(com.watsonh.fractlauncher.R.dimen.blur_size_click_shadow);
        mShadowOffset = getResources().getDimension(com.watsonh.fractlauncher.R.dimen.click_shadow_high_shift);
    }
