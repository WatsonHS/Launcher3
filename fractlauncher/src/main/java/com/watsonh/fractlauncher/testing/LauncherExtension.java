package com.watsonh.fractlauncher.testing;
...
import com.watsonh.fractlauncher.LauncherCallbacks;
import com.watsonh.fractlauncher.allapps.AllAppsSearchBarController;
import com.watsonh.fractlauncher.util.ComponentKey;
import com.watsonh.fractlauncher.AppInfo;
import com.watsonh.fractlauncher.InsettableFrameLayout;
import com.watsonh.fractlauncher.LauncherAnimUtils;
        ...
        class LauncherExtensionOverlay implements LauncherOverlay {
            ...
            public void setOverlayContainer(InsettableFrameLayout container) {
                mOverlayView = (ViewGroup) getLayoutInflater().inflate(
                        com.watsonh.fractlauncher.R.layout.launcher_overlay_example, container);
                mSearchOverlay = mOverlayView.findViewById(com.watsonh.fractlauncher.R.id.search_overlay);
                mSearchBox = mOverlayView.findViewById(com.watsonh.fractlauncher.R.id.search_box);
            }
