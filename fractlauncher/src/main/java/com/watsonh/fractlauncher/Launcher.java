...
import com.watsonh.fractlauncher.DropTarget.DragObject;
import com.watsonh.fractlauncher.PagedView.PageSwitchListener;
import com.watsonh.fractlauncher.allapps.AllAppsContainerView;
import com.watsonh.fractlauncher.compat.AppWidgetManagerCompat;
import com.watsonh.fractlauncher.compat.LauncherActivityInfoCompat;
import com.watsonh.fractlauncher.compat.LauncherAppsCompat;
import com.watsonh.fractlauncher.compat.UserHandleCompat;
import com.watsonh.fractlauncher.compat.UserManagerCompat;
import com.watsonh.fractlauncher.model.WidgetsModel;
import com.watsonh.fractlauncher.util.ComponentKey;
import com.watsonh.fractlauncher.util.LongArrayMap;
import com.watsonh.fractlauncher.util.Thunk;
import com.watsonh.fractlauncher.widget.PendingAddWidgetInfo;
import com.watsonh.fractlauncher.widget.WidgetHostViewLoader;
import com.watsonh.fractlauncher.widget.WidgetsContainerView;
...
public class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.watsonh.fractlauncher.R.layout.launcher);
        ...
        if (mLauncherCallbacks != null) {
            ...
            if (mLauncherCallbacks.hasLauncherOverlay()) {
                ViewStub stub = (ViewStub) findViewById(com.watsonh.fractlauncher.R.id.launcher_overlay_stub);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        if (requestCode == REQUEST_PERMISSION_CALL_PHONE && sPendingAddItem != null
            ...
            if (grantResults.length > 0
                ...
                Toast.makeText(this, getString(com.watsonh.fractlauncher.R.string.msg_no_phone_permission,
                        getString(com.watsonh.fractlauncher.R.string.app_name)), Toast.LENGTH_SHORT).show();
            }
        }
        if (mLauncherCallbacks != null) {
    ...
    private void setupViews() {
        ...
        mLauncherView = findViewById(com.watsonh.fractlauncher.R.id.launcher);
        mFocusHandler = (FocusIndicatorView) findViewById(com.watsonh.fractlauncher.R.id.focus_indicator);
        mDragLayer = (DragLayer) findViewById(com.watsonh.fractlauncher.R.id.drag_layer);
        mWorkspace = (Workspace) mDragLayer.findViewById(com.watsonh.fractlauncher.R.id.workspace);
        mWorkspace.setPageSwitchListener(this);
        mPageIndicators = mDragLayer.findViewById(com.watsonh.fractlauncher.R.id.page_indicator);

        mLauncherView.setSystemUiVisibility(
                View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION);
        mWorkspaceBackgroundDrawable = getResources().getDrawable(com.watsonh.fractlauncher.R.drawable.workspace_bg);

        // Setup the drag layer
        mDragLayer.setup(this, dragController);

        // Setup the hotseat
        mHotseat = (Hotseat) findViewById(com.watsonh.fractlauncher.R.id.hotseat);
        if (mHotseat != null) {
            mHotseat.setOnLongClickListener(this);
        }

        mOverviewPanel = (ViewGroup) findViewById(com.watsonh.fractlauncher.R.id.overview_panel);
        mWidgetsButton = findViewById(com.watsonh.fractlauncher.R.id.widget_button);
        ...
        View wallpaperButton = findViewById(com.watsonh.fractlauncher.R.id.wallpaper_button);
        ...
        View settingsButton = findViewById(com.watsonh.fractlauncher.R.id.settings_button);
        if (hasSettings()) {
        ...
        mSearchDropTargetBar = (SearchDropTargetBar)
                mDragLayer.findViewById(com.watsonh.fractlauncher.R.id.search_drop_target_bar);

        // Setup Apps and Widgets
        mAppsView = (AllAppsContainerView) findViewById(com.watsonh.fractlauncher.R.id.apps_view);
        mWidgetsView = (WidgetsContainerView) findViewById(com.watsonh.fractlauncher.R.id.widgets_view);
        ...
        if (getResources().getBoolean(com.watsonh.fractlauncher.R.bool.debug_memory_enabled)) {
    ...
    public View createShortcut(ViewGroup parent, ShortcutInfo info) {
        BubbleTextView favorite = (BubbleTextView) mInflater.inflate(com.watsonh.fractlauncher.R.layout.app_icon,
                parent, false);
    ...
    public void showOutOfSpaceMessage(boolean isHotseatLayout) {
        int strId = (isHotseatLayout ? com.watsonh.fractlauncher.R.string.hotseat_out_of_space : com.watsonh.fractlauncher.R.string.out_of_space);
    ...
    FolderIcon addFolder(CellLayout layout, long container, final long screenId, int cellX,
        ...
        folderInfo.title = getText(com.watsonh.fractlauncher.R.string.folder_name);
        ...
        FolderIcon newFolder =
            FolderIcon.fromXml(com.watsonh.fractlauncher.R.layout.folder_icon, this, layout, folderInfo, mIconCache);
    ...
    public void onClickPendingWidget(final PendingAppWidgetHostView v) {
        if (mIsSafeModeEnabled) {
            Toast.makeText(this, com.watsonh.fractlauncher.R.string.safemode_widget_error, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void showBrokenAppInstallDialog(final String packageName,
        ...
        new AlertDialog.Builder(this)
            .setTitle(com.watsonh.fractlauncher.R.string.abandoned_promises_title)
            .setMessage(com.watsonh.fractlauncher.R.string.abandoned_promise_explanation)
            .setPositiveButton(com.watsonh.fractlauncher.R.string.abandoned_search, onSearchClickListener)
            .setNeutralButton(com.watsonh.fractlauncher.R.string.abandoned_clean_this,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
    ...
    protected void onClickAppShortcut(final View v) {
        ...
        if (shortcut.isDisabled != 0) {
            int error = com.watsonh.fractlauncher.R.string.activity_not_available;
            if ((shortcut.isDisabled & ShortcutInfo.FLAG_DISABLED_SAFEMODE) != 0) {
                error = com.watsonh.fractlauncher.R.string.safemode_shortcut_error;
            }
    ...
    void startApplicationDetailsActivity(ComponentName componentName, UserHandleCompat user) {
        try {
            ...
            Toast.makeText(this, com.watsonh.fractlauncher.R.string.activity_not_found, Toast.LENGTH_SHORT).show();
    ...
    boolean startApplicationUninstallActivity(ComponentName componentName, int flags,
        ...
        if ((flags & AppInfo.DOWNLOADED_FLAG) == 0) {
            ...
            int messageId = com.watsonh.fractlauncher.R.string.uninstall_system_app_text;
            ...
            if (useLaunchAnimation) {
                ...
                if (Utilities.ATLEAST_MARSHMALLOW) {
                    ...
                    opts = ActivityOptions.makeCustomAnimation(this,
                            com.watsonh.fractlauncher.R.anim.task_open_enter, com.watsonh.fractlauncher.R.anim.no_anim);
                }
    ...
    public boolean startActivitySafely(View v, Intent intent, Object tag) {
        ...
        if (mIsSafeModeEnabled && !Utilities.isSystemApp(this, intent)) {
            Toast.makeText(this, com.watsonh.fractlauncher.R.string.safemode_shortcut_error, Toast.LENGTH_SHORT).show();
            return false;
        }
        try {
    ...
    private void growAndFadeOutFolderIcon(FolderIcon fi) {
        ...
        oa.setDuration(getResources().getInteger(com.watsonh.fractlauncher.R.integer.config_folderExpandDuration));
        oa.start();
    }
    ...
    public View getOrCreateQsbBar() {
        ...
        if (mQsb == null) {
            ...
            if (widgetId != -1) {
                ...
                mQsb.setId(com.watsonh.fractlauncher.R.id.qsb_widget);
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        ...
        if (mState == State.APPS) {
            text.add(getString(com.watsonh.fractlauncher.R.string.all_apps_button_label));
        } else if (mState == State.WIDGETS) {
            text.add(getString(com.watsonh.fractlauncher.R.string.widget_button_text));
        } else if (mWorkspace != null) {
            text.add(mWorkspace.getCurrentPageDescription());
        } else {
            text.add(getString(com.watsonh.fractlauncher.R.string.all_apps_home_button_label));
        }
        return result;
    }
        ...
        for (int i = start; i < end; i++) {
            ...
            switch (item.itemType) {
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_FOLDER:
                    view = FolderIcon.fromXml(com.watsonh.fractlauncher.R.layout.folder_icon, this,
    ...
    private void sendLoadingCompleteBroadcastIfNecessary() {
        if (!mSharedPrefs.getBoolean(FIRST_LOAD_COMPLETE, false)) {
            String permission =
                    getResources().getString(com.watsonh.fractlauncher.R.string.receive_first_load_broadcast_permission);
