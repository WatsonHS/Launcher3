...
import com.watsonh.fractlauncher.util.FocusLogic;
...
public class FocusHelper {
    ...
    static boolean handleHotseatButtonKeyEvent(View v, int keyCode, KeyEvent e) {
        ...
        Workspace workspace = (Workspace) v.getRootView().findViewById(com.watsonh.fractlauncher.R.id.workspace);
    ...
    static boolean handleIconKeyEvent(View v, int keyCode, KeyEvent e) {
        ...
        final ViewGroup tabs = (ViewGroup) dragLayer.findViewById(com.watsonh.fractlauncher.R.id.search_drop_target_bar);
        final Hotseat hotseat = (Hotseat) dragLayer.findViewById(com.watsonh.fractlauncher.R.id.hotseat);
