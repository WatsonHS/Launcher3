...
import com.watsonh.fractlauncher.accessibility.WorkspaceAccessibilityHelper;
import com.watsonh.fractlauncher.util.Thunk;
import com.watsonh.fractlauncher.accessibility.DragAndDropAccessibilityDelegate;
import com.watsonh.fractlauncher.accessibility.FolderAccessibilityHelper;
...
public class CellLayout extends ViewGroup implements BubbleTextView.BubbleTextShadowHandler {
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.watsonh.fractlauncher.R.styleable.CellLayout, defStyle, 0);
        ...
        mBackground = (TransitionDrawable) res.getDrawable(com.watsonh.fractlauncher.R.drawable.bg_screenpanel);
        ...
        final int duration = res.getInteger(com.watsonh.fractlauncher.R.integer.config_dragOutlineFadeTime);
        final float fromAlphaValue = 0;
        final float toAlphaValue = (float)res.getInteger(com.watsonh.fractlauncher.R.integer.config_dragOutlineMaxAlpha);
