...
import com.watsonh.fractlauncher.util.FlingAnimation;
...
public class DeleteDropTarget extends ButtonDropTarget {
    ...
    protected void onFinishInflate() {
        ...
        // Get the hover color
        mHoverColor = getResources().getColor(com.watsonh.fractlauncher.R.color.delete_target_hover_tint);

        setDrawable(com.watsonh.fractlauncher.R.drawable.ic_remove_launcher);
    }
    ...
    protected String getAccessibilityDropConfirmation() {
        return getResources().getString(com.watsonh.fractlauncher.R.string.item_removed);
    }
}
