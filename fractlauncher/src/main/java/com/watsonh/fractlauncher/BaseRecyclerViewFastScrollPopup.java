...
public class BaseRecyclerViewFastScrollPopup {
    ...
    public BaseRecyclerViewFastScrollPopup(BaseRecyclerView rv, Resources res) {
        mRes = res;
        mRv = rv;
        mBgOriginalSize = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.container_fastscroll_popup_size);
        mBg = res.getDrawable(com.watsonh.fractlauncher.R.drawable.container_fastscroll_popup_bg);
        mBg.setBounds(0, 0, mBgOriginalSize, mBgOriginalSize);
        mTextPaint = new Paint();
        mTextPaint.setColor(Color.WHITE);
        mTextPaint.setAntiAlias(true);
        mTextPaint.setTextSize(res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.container_fastscroll_popup_text_size));
    }
