...
import com.watsonh.fractlauncher.util.LauncherEdgeEffect;
...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    public PagedView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.watsonh.fractlauncher.R.styleable.PagedView, defStyle, 0);

        mPageLayoutWidthGap = a.getDimensionPixelSize(
                com.watsonh.fractlauncher.R.styleable.PagedView_pageLayoutWidthGap, 0);
        mPageLayoutHeightGap = a.getDimensionPixelSize(
                com.watsonh.fractlauncher.R.styleable.PagedView_pageLayoutHeightGap, 0);
        mPageIndicatorViewId = a.getResourceId(com.watsonh.fractlauncher.R.styleable.PagedView_pageIndicator, -1);
        a.recycle();
    ...
    protected String getCurrentPageDescription() {
        return String.format(getContext().getString(com.watsonh.fractlauncher.R.string.default_scroll_format),
