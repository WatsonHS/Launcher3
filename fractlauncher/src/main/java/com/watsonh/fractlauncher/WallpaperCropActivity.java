...
import com.watsonh.fractlauncher.base.BaseActivity;
...
import com.watsonh.photos.BitmapRegionTileSource.BitmapSource.InBitmapProvider;
...
public class WallpaperCropActivity extends BaseActivity implements Handler.Callback {
    ...
    protected void init() {
        setContentView(com.watsonh.fractlauncher.R.layout.wallpaper_cropper);
        ...
        Runnable onLoad = new Runnable() {
            public void run() {
                if (bitmapSource.getLoadingState() != BitmapSource.State.LOADED) {
                    Toast.makeText(getContext(), com.watsonh.fractlauncher.R.string.wallpaper_load_fail,
    ...
    public boolean enableRotation() {
        return getResources().getBoolean(com.watsonh.fractlauncher.R.bool.allow_rotation);
    }
    ...
    protected void cropImageAndSetWallpaper(Uri uri,
        ...
        boolean centerCrop = getResources().getBoolean(com.watsonh.fractlauncher.R.bool.center_crop);
        // Get the crop
