...
import com.watsonh.fractlauncher.FocusHelper.PagedFolderKeyEventListener;
...
public class FolderPagedView extends PagedView {
    ...
    public FolderPagedView(Context context, AttributeSet attrs) {
        ...
        setEdgeGlowColor(getResources().getColor(com.watsonh.fractlauncher.R.color.folder_edge_effect_color));
    }

    public void setFolder(Folder folder) {
        mFolder = folder;
        mFocusIndicatorView = (FocusIndicatorView) folder.findViewById(com.watsonh.fractlauncher.R.id.focus_indicator);
        mKeyListener = new PagedFolderKeyEventListener(folder);
        mPageIndicator = (PageIndicator) folder.findViewById(com.watsonh.fractlauncher.R.id.folder_page_indicator);
    }
    ...
    public View createNewView(ShortcutInfo item) {
        final BubbleTextView textView = (BubbleTextView) mInflater.inflate(
                com.watsonh.fractlauncher.R.layout.folder_application, null, false);
    ...
    protected PageIndicator.PageMarkerResources getPageIndicatorMarker(int pageIndex) {
        return new PageIndicator.PageMarkerResources(com.watsonh.fractlauncher.R.drawable.ic_pageindicator_current_folder,
                com.watsonh.fractlauncher.R.drawable.ic_pageindicator_default_folder);
    }
    ...
    public String getAccessibilityDescription() {
        return String.format(getContext().getString(com.watsonh.fractlauncher.R.string.folder_opened),
