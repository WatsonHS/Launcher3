...
public class PageIndicatorMarker extends FrameLayout {
    ...
    protected void onFinishInflate() {
        mActiveMarker = (ImageView) findViewById(com.watsonh.fractlauncher.R.id.active);
        mInactiveMarker = (ImageView) findViewById(com.watsonh.fractlauncher.R.id.inactive);
    }
