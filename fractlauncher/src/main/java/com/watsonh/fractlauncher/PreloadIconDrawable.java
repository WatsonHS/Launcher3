...
class PreloadIconDrawable extends Drawable {
    ...
    public void applyPreloaderTheme(Theme t) {
        TypedArray ta = t.obtainStyledAttributes(com.watsonh.fractlauncher.R.styleable.PreloadIconDrawable);
        mBgDrawable = ta.getDrawable(com.watsonh.fractlauncher.R.styleable.PreloadIconDrawable_background);
        mBgDrawable.setFilterBitmap(true);
        mPaint.setStrokeWidth(ta.getDimension(com.watsonh.fractlauncher.R.styleable.PreloadIconDrawable_indicatorSize, 0));
        mRingOutset = ta.getDimensionPixelSize(com.watsonh.fractlauncher.R.styleable.PreloadIconDrawable_ringOutset, 0);
        ta.recycle();
