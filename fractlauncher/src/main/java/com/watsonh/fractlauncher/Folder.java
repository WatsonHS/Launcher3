...
import com.watsonh.fractlauncher.CellLayout.CellInfo;
...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        mExpandDuration = res.getInteger(com.watsonh.fractlauncher.R.integer.config_folderExpandDuration);
        mMaterialExpandDuration = res.getInteger(com.watsonh.fractlauncher.R.integer.config_materialFolderExpandDuration);
        mMaterialExpandStagger = res.getInteger(com.watsonh.fractlauncher.R.integer.config_materialFolderExpandStagger);

        if (sDefaultFolderName == null) {
            sDefaultFolderName = res.getString(com.watsonh.fractlauncher.R.string.folder_name);
        }
        if (sHintText == null) {
            sHintText = res.getString(com.watsonh.fractlauncher.R.string.folder_hint_text);
        }
    ...
    protected void onFinishInflate() {
        ...
        mContentWrapper = findViewById(com.watsonh.fractlauncher.R.id.folder_content_wrapper);
        mContent = (FolderPagedView) findViewById(com.watsonh.fractlauncher.R.id.folder_content);
        mContent.setFolder(this);

        mFolderName = (ExtendedEditText) findViewById(com.watsonh.fractlauncher.R.id.folder_name);
        ...
        mFooter = findViewById(com.watsonh.fractlauncher.R.id.folder_footer);
    ...
    public void doneEditingFolderName(boolean commit) {
        ...
        if (commit) {
            sendCustomAccessibilityEvent(AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED,
                    String.format(getContext().getString(com.watsonh.fractlauncher.R.string.folder_renamed), newTitle));
        }
    ...
    static Folder fromXml(Launcher launcher) {
        return (Folder) launcher.getLayoutInflater().inflate(com.watsonh.fractlauncher.R.layout.user_folder, null);
    }
    ...
    public void animateClosed() {
        ...
        oa.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                sendCustomAccessibilityEvent(AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED,
                        getContext().getString(com.watsonh.fractlauncher.R.string.folder_closed));
                mState = STATE_ANIMATING;
            }
        });
        oa.setDuration(mExpandDuration);
    ...
    private void centerAboutIcon() {
        ...
        DragLayer parent = (DragLayer) mLauncher.findViewById(com.watsonh.fractlauncher.R.id.drag_layer);
        int width = getPaddingLeft() + getPaddingRight() + mContent.getDesiredWidth();
        int height = getFolderHeight();
