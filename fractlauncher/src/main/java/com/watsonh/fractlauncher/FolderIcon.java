...
public class FolderIcon extends FrameLayout implements FolderInfo.FolderListener {
    ...
    static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        icon.mFolderName = (BubbleTextView) icon.findViewById(com.watsonh.fractlauncher.R.id.folder_icon_name);
        ...
        icon.mPreviewBackground = (ImageView) icon.findViewById(com.watsonh.fractlauncher.R.id.preview_background);
        ...
        icon.setContentDescription(String.format(launcher.getString(com.watsonh.fractlauncher.R.string.folder_name_format),
                folderInfo.title));
    ...
    public static class FolderRingAnimator {
        ...
        public FolderRingAnimator(Launcher launcher, FolderIcon folderIcon) {
            ...
            if (sStaticValuesDirty) {
                ...
                sPreviewPadding = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.folder_preview_padding);
                sSharedOuterRingDrawable = res.getDrawable(com.watsonh.fractlauncher.R.drawable.portal_ring_outer);
                sSharedInnerRingDrawable = res.getDrawable(com.watsonh.fractlauncher.R.drawable.portal_ring_inner_nolip);
                sSharedFolderLeaveBehind = res.getDrawable(com.watsonh.fractlauncher.R.drawable.portal_ring_rest);
    ...
    public void onTitleChanged(CharSequence title) {
        ...
        setContentDescription(String.format(getContext().getString(com.watsonh.fractlauncher.R.string.folder_name_format),
                title));
    }
