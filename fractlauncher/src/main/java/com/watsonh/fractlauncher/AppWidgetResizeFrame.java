...
public class AppWidgetResizeFrame extends FrameLayout {
    ...
    public AppWidgetResizeFrame(Context context,
        ...
        setBackgroundResource(com.watsonh.fractlauncher.R.drawable.widget_resize_shadow);
        setForeground(getResources().getDrawable(com.watsonh.fractlauncher.R.drawable.widget_resize_frame));
        setPadding(0, 0, 0, 0);

        final int handleMargin = getResources().getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.widget_handle_margin);
        LayoutParams lp;
        mLeftHandle = new ImageView(context);
        mLeftHandle.setImageResource(com.watsonh.fractlauncher.R.drawable.ic_widget_resize_handle);
        ...
        mRightHandle.setImageResource(com.watsonh.fractlauncher.R.drawable.ic_widget_resize_handle);
        lp = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT,
        ...
        mTopHandle.setImageResource(com.watsonh.fractlauncher.R.drawable.ic_widget_resize_handle);
        lp = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT,
        ...
        mBottomHandle.setImageResource(com.watsonh.fractlauncher.R.drawable.ic_widget_resize_handle);
        lp = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT,
        ...
        if (!info.isCustomWidget) {
            ...
            int padding = r.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.default_widget_padding);
        ...
        mBackgroundPadding = getResources()
                .getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.resize_frame_background_padding);
