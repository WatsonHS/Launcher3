...
class LauncherClings implements OnClickListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == com.watsonh.fractlauncher.R.id.cling_dismiss_migration_use_default) {
            // Disable the migration cling
            dismissMigrationCling();
        } else if (id == com.watsonh.fractlauncher.R.id.cling_dismiss_migration_copy_apps) {
            ...
            // Disable the migration cling
            dismissMigrationCling();
        } else if (id == com.watsonh.fractlauncher.R.id.cling_dismiss_longpress_info) {
    ...
    public void showMigrationCling() {
        ...
        ViewGroup root = (ViewGroup) mLauncher.findViewById(com.watsonh.fractlauncher.R.id.launcher);
        View inflated = mInflater.inflate(com.watsonh.fractlauncher.R.layout.migration_cling, root);
        inflated.findViewById(com.watsonh.fractlauncher.R.id.cling_dismiss_migration_copy_apps).setOnClickListener(this);
        inflated.findViewById(com.watsonh.fractlauncher.R.id.cling_dismiss_migration_use_default).setOnClickListener(this);
    }
    ...
    private void dismissMigrationCling() {
        ...
        Runnable dismissCb = new Runnable() {
            public void run() {
                ...
                dismissCling(mLauncher.findViewById(com.watsonh.fractlauncher.R.id.migration_cling), cb,
    ...
    public void showLongPressCling(boolean showWelcome) {
        mIsVisible = true;
        ViewGroup root = (ViewGroup) mLauncher.findViewById(com.watsonh.fractlauncher.R.id.launcher);
        View cling = mInflater.inflate(com.watsonh.fractlauncher.R.layout.longpress_cling, root, false);
        ...
        final ViewGroup content = (ViewGroup) cling.findViewById(com.watsonh.fractlauncher.R.id.cling_content);
        mInflater.inflate(showWelcome ? com.watsonh.fractlauncher.R.layout.longpress_cling_welcome_content
                : com.watsonh.fractlauncher.R.layout.longpress_cling_content, content);
        content.findViewById(com.watsonh.fractlauncher.R.id.cling_dismiss_longpress_info).setOnClickListener(this);

        if (TAG_CROP_TOP_AND_SIDES.equals(content.getTag())) {
            Drawable bg = new BorderCropDrawable(mLauncher.getResources().getDrawable(com.watsonh.fractlauncher.R.drawable.cling_bg),
    ...
    @Thunk void dismissLongPressCling() {
        Runnable dismissCb = new Runnable() {
            public void run() {
                dismissCling(mLauncher.findViewById(com.watsonh.fractlauncher.R.id.longpress_cling), null,
