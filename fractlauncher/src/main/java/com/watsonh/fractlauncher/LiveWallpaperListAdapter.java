...
public class LiveWallpaperListAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = mInflater.inflate(com.watsonh.fractlauncher.R.layout.wallpaper_picker_live_wallpaper_item, parent, false);
        } else {
            view = convertView;
        }
        ...
        ImageView icon = (ImageView) view.findViewById(com.watsonh.fractlauncher.R.id.wallpaper_icon);
        ...
        TextView label = (TextView) view.findViewById(com.watsonh.fractlauncher.R.id.wallpaper_item_label);
