...
import com.watsonh.fractlauncher.util.UiThreadCircularReveal;
...
public class LauncherStateTransitionAnimation {
    ...
    private AnimatorSet startAnimationToOverlay(final Workspace.State fromWorkspaceState,
        ...
        final int revealDuration = res.getInteger(com.watsonh.fractlauncher.R.integer.config_overlayRevealTime);
        final int itemsAlphaStagger =
                res.getInteger(com.watsonh.fractlauncher.R.integer.config_overlayItemsAlphaStagger);
