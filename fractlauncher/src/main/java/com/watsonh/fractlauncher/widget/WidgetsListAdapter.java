...
import com.watsonh.fractlauncher.LauncherAppWidgetProviderInfo;
...
import com.watsonh.fractlauncher.model.PackageItemInfo;
...
public class WidgetsListAdapter extends Adapter<WidgetsRowViewHolder> {
    ...
    public void onBindViewHolder(WidgetsRowViewHolder holder, int pos) {
        ...
        ViewGroup row = ((ViewGroup) holder.getContent().findViewById(com.watsonh.fractlauncher.R.id.widgets_cell_list));
        if (DEBUG) {
        ...
        if (diff > 0) {
            for (int i = 0; i < diff; i++) {
                WidgetCell widget = (WidgetCell) mLayoutInflater.inflate(
                        com.watsonh.fractlauncher.R.layout.widget_cell, row, false);
        ...
        BubbleTextView tv = ((BubbleTextView) holder.getContent().findViewById(com.watsonh.fractlauncher.R.id.section));
    ...
    public WidgetsRowViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewGroup container = (ViewGroup) mLayoutInflater.inflate(
                com.watsonh.fractlauncher.R.layout.widgets_list_row_view, parent, false);
        LinearLayout cellList = (LinearLayout) container.findViewById(com.watsonh.fractlauncher.R.id.widgets_cell_list);
