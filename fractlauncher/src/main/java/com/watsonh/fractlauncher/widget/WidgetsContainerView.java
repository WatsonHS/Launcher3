...
package com.watsonh.fractlauncher.widget;
...
public class WidgetsContainerView extends BaseContainerView
    ...
    protected void onFinishInflate() {
        ...
        mView = (WidgetsRecyclerView) findViewById(com.watsonh.fractlauncher.R.id.widgets_list_view);
    ...
    public View getRevealView() {
        ...
        return findViewById(com.watsonh.fractlauncher.R.id.widgets_reveal_view);
    }
    ...
    public void onClick(View v) {
        ...
        mWidgetInstructionToast = Toast.makeText(getContext(), com.watsonh.fractlauncher.R.string.long_press_widget_to_add,
                Toast.LENGTH_SHORT);
    ...
    private boolean beginDraggingWidget(WidgetCell v) {
        ...
        WidgetImageView image = (WidgetImageView) v.findViewById(com.watsonh.fractlauncher.R.id.widget_preview);
    ...
    protected void onUpdateBackgroundAndPaddings(Rect searchBarBounds, Rect padding) {
        ...
        InsetDrawable background = new InsetDrawable(
                getResources().getDrawable(com.watsonh.fractlauncher.R.drawable.quantum_panel_shape_dark), padding.left, 0,
                padding.right, 0);
