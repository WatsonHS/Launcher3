...
import com.watsonh.fractlauncher.InvariantDeviceProfile;
...
import com.watsonh.fractlauncher.StylusEventHelper;
...
public class WidgetCell extends LinearLayout implements OnLayoutChangeListener {
    ...
    public WidgetCell(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDimensionsFormatString = r.getString(com.watsonh.fractlauncher.R.string.widget_dims_format);
        setContainerWidth();
    ...
    protected void onFinishInflate() {
        ...
        mWidgetImage = (WidgetImageView) findViewById(com.watsonh.fractlauncher.R.id.widget_preview);
        mWidgetName = ((TextView) findViewById(com.watsonh.fractlauncher.R.id.widget_name));
        mWidgetDims = ((TextView) findViewById(com.watsonh.fractlauncher.R.id.widget_dims));
    }
