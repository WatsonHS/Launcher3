...
public class WorkspaceStateTransitionAnimation {
    ...
    public WorkspaceStateTransitionAnimation(Launcher launcher, Workspace workspace) {
        ...
        mAllAppsTransitionTime = res.getInteger(com.watsonh.fractlauncher.R.integer.config_allAppsTransitionTime);
        mOverviewTransitionTime = res.getInteger(com.watsonh.fractlauncher.R.integer.config_overviewTransitionTime);
        mOverlayTransitionTime = res.getInteger(com.watsonh.fractlauncher.R.integer.config_overlayTransitionTime);
        mSpringLoadedShrinkFactor =
                res.getInteger(com.watsonh.fractlauncher.R.integer.config_workspaceSpringLoadShrinkPercentage) / 100f;
        mOverviewModeShrinkFactor =
                res.getInteger(com.watsonh.fractlauncher.R.integer.config_workspaceOverviewShrinkPercentage) / 100f;
        mWorkspaceScrimAlpha = res.getInteger(com.watsonh.fractlauncher.R.integer.config_workspaceScrimAlpha) / 100f;
