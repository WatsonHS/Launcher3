...
public class Hotseat extends FrameLayout
    ...
    protected void onFinishInflate() {
        ...
        mContent = (CellLayout) findViewById(com.watsonh.fractlauncher.R.id.layout);
    ...
    void resetLayout() {
        ...
        TextView allAppsButton = (TextView)
                inflater.inflate(com.watsonh.fractlauncher.R.layout.all_apps_button, mContent, false);
        Drawable d = context.getResources().getDrawable(com.watsonh.fractlauncher.R.drawable.all_apps_button_icon);

        mLauncher.resizeIconDrawable(d);
        allAppsButton.setCompoundDrawables(null, d, null, null);

        allAppsButton.setContentDescription(context.getString(com.watsonh.fractlauncher.R.string.all_apps_button_label));
