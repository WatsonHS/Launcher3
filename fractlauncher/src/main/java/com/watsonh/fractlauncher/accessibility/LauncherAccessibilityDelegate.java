package com.watsonh.fractlauncher.accessibility;
...
import com.watsonh.fractlauncher.DeleteDropTarget;
import com.watsonh.fractlauncher.Launcher;
import com.watsonh.fractlauncher.Workspace;
import com.watsonh.fractlauncher.AppInfo;
import com.watsonh.fractlauncher.AppWidgetResizeFrame;
import com.watsonh.fractlauncher.CellLayout;
import com.watsonh.fractlauncher.DragController.DragListener;
import com.watsonh.fractlauncher.DragSource;
import com.watsonh.fractlauncher.Folder;
import com.watsonh.fractlauncher.FolderInfo;
import com.watsonh.fractlauncher.InfoDropTarget;
import com.watsonh.fractlauncher.ItemInfo;
import com.watsonh.fractlauncher.LauncherAppWidgetHostView;
import com.watsonh.fractlauncher.LauncherAppWidgetInfo;
import com.watsonh.fractlauncher.LauncherModel;
import com.watsonh.fractlauncher.LauncherSettings;
import com.watsonh.fractlauncher.PendingAddItemInfo;
import com.watsonh.fractlauncher.ShortcutInfo;
import com.watsonh.fractlauncher.UninstallDropTarget;
...
public class LauncherAccessibilityDelegate extends AccessibilityDelegate implements DragListener {
    ...
    private static final int REMOVE = com.watsonh.fractlauncher.R.id.action_remove;
    private static final int INFO = com.watsonh.fractlauncher.R.id.action_info;
    private static final int UNINSTALL = com.watsonh.fractlauncher.R.id.action_uninstall;
    private static final int ADD_TO_WORKSPACE = com.watsonh.fractlauncher.R.id.action_add_to_workspace;
    private static final int MOVE = com.watsonh.fractlauncher.R.id.action_move;
    private static final int MOVE_TO_WORKSPACE = com.watsonh.fractlauncher.R.id.action_move_to_workspace;
    private static final int RESIZE = com.watsonh.fractlauncher.R.id.action_resize;
    ...
    public LauncherAccessibilityDelegate(Launcher launcher) {
        ...
        mActions.put(REMOVE, new AccessibilityAction(REMOVE,
                launcher.getText(com.watsonh.fractlauncher.R.string.delete_target_label)));
        mActions.put(INFO, new AccessibilityAction(INFO,
                launcher.getText(com.watsonh.fractlauncher.R.string.info_target_label)));
        mActions.put(UNINSTALL, new AccessibilityAction(UNINSTALL,
                launcher.getText(com.watsonh.fractlauncher.R.string.delete_target_uninstall_label)));
        mActions.put(ADD_TO_WORKSPACE, new AccessibilityAction(ADD_TO_WORKSPACE,
                launcher.getText(com.watsonh.fractlauncher.R.string.action_add_to_workspace)));
        mActions.put(MOVE, new AccessibilityAction(MOVE,
                launcher.getText(com.watsonh.fractlauncher.R.string.action_move)));
        mActions.put(MOVE_TO_WORKSPACE, new AccessibilityAction(MOVE_TO_WORKSPACE,
                launcher.getText(com.watsonh.fractlauncher.R.string.action_move_to_workspace)));
        mActions.put(RESIZE, new AccessibilityAction(RESIZE,
                        launcher.getText(com.watsonh.fractlauncher.R.string.action_resize)));
    }
    ...
    public boolean performAction(final View host, final ItemInfo item, int action) {
        if (action == REMOVE) {
            if (DeleteDropTarget.removeWorkspaceOrFolderItem(mLauncher, item, host)) {
                announceConfirmation(com.watsonh.fractlauncher.R.string.item_removed);
                return true;
            }
            return false;
        } else if (action == INFO) {
            ...
            mLauncher.showWorkspace(true, new Runnable() {
                ...
                public void run() {
                    ...
                    announceConfirmation(com.watsonh.fractlauncher.R.string.item_added_to_workspace);
                }
            });
            return true;
            ...
            new Handler().post(new Runnable() {
                ...
                public void run() {
                    ...
                    itemList.add(item);
                    mLauncher.bindItems(itemList, 0, itemList.size(), true);
                    announceConfirmation(com.watsonh.fractlauncher.R.string.item_moved);
                }
            });
            ...
            new AlertDialog.Builder(mLauncher)
                .setTitle(com.watsonh.fractlauncher.R.string.action_resize)
    ...
    private ArrayList<Integer> getSupportedResizeActions(View host, LauncherAppWidgetInfo info) {
        ...
        if ((providerInfo.resizeMode & AppWidgetProviderInfo.RESIZE_HORIZONTAL) != 0) {
            if (layout.isRegionVacant(info.cellX + info.spanX, info.cellY, 1, info.spanY) ||
                ...
                actions.add(com.watsonh.fractlauncher.R.string.action_increase_width);
            }

            if (info.spanX > info.minSpanX && info.spanX > 1) {
                actions.add(com.watsonh.fractlauncher.R.string.action_decrease_width);
            }
        }
        ...
        if ((providerInfo.resizeMode & AppWidgetProviderInfo.RESIZE_VERTICAL) != 0) {
            if (layout.isRegionVacant(info.cellX, info.cellY + info.spanY, info.spanX, 1) ||
                ...
                actions.add(com.watsonh.fractlauncher.R.string.action_increase_height);
            }

            if (info.spanY > info.minSpanY && info.spanY > 1) {
                actions.add(com.watsonh.fractlauncher.R.string.action_decrease_height);
            }
        }
        return actions;
    }
    ...
    @Thunk void performResizeAction(int action, View host, LauncherAppWidgetInfo info) {
        ...
        if (action == com.watsonh.fractlauncher.R.string.action_increase_width) {
            ...
            lp.cellHSpan ++;
            info.spanX ++;
        } else if (action == com.watsonh.fractlauncher.R.string.action_decrease_width) {
            lp.cellHSpan --;
            info.spanX --;
        } else if (action == com.watsonh.fractlauncher.R.string.action_increase_height) {
            if (!layout.isRegionVacant(info.cellX, info.cellY + info.spanY, info.spanX, 1)) {
                lp.cellY --;
                info.cellY --;
            }
            lp.cellVSpan ++;
            info.spanY ++;
        } else if (action == com.watsonh.fractlauncher.R.string.action_decrease_height) {
            lp.cellVSpan --;
            info.spanY --;
        }
        ...
        announceConfirmation(mLauncher.getString(com.watsonh.fractlauncher.R.string.widget_resized, info.spanX, info.spanY));
    }
