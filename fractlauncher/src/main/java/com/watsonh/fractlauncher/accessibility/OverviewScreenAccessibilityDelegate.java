...
public class OverviewScreenAccessibilityDelegate extends AccessibilityDelegate {
    ...
    private static final int MOVE_BACKWARD = com.watsonh.fractlauncher.R.id.action_move_screen_backwards;
    private static final int MOVE_FORWARD = com.watsonh.fractlauncher.R.id.action_move_screen_forwards;
    ...
    public OverviewScreenAccessibilityDelegate(Workspace workspace) {
        ...
        mActions.put(MOVE_BACKWARD, new AccessibilityAction(MOVE_BACKWARD,
                context.getText(isRtl ? com.watsonh.fractlauncher.R.string.action_move_screen_right :
                    com.watsonh.fractlauncher.R.string.action_move_screen_left)));
        mActions.put(MOVE_FORWARD, new AccessibilityAction(MOVE_FORWARD,
                context.getText(isRtl ? com.watsonh.fractlauncher.R.string.action_move_screen_left :
                    com.watsonh.fractlauncher.R.string.action_move_screen_right)));
    }
    ...
    private void movePage(int finalIndex, View view) {
        ...
        mWorkspace.announceForAccessibility(mWorkspace.getContext().getText(com.watsonh.fractlauncher.R.string.screen_moved));
