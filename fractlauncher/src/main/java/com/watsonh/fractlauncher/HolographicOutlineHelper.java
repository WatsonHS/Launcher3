...
public class HolographicOutlineHelper {
    ...
    private HolographicOutlineHelper(Context context) {
        ...
        float mediumBlur = res.getDimension(com.watsonh.fractlauncher.R.dimen.blur_size_medium_outline);
        ...
        mThinOuterBlurMaskFilter = new BlurMaskFilter(
                res.getDimension(com.watsonh.fractlauncher.R.dimen.blur_size_thin_outline), BlurMaskFilter.Blur.OUTER);

        mShadowBlurMaskFilter = new BlurMaskFilter(
                res.getDimension(com.watsonh.fractlauncher.R.dimen.blur_size_click_shadow), BlurMaskFilter.Blur.NORMAL);
