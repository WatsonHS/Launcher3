...
public class BaseRecyclerViewFastScrollBar {
    ...
    public BaseRecyclerViewFastScrollBar(BaseRecyclerView rv, Resources res) {
        ...
        mThumbInactiveColor = rv.getFastScrollerThumbInactiveColor(
                res.getColor(com.watsonh.fractlauncher.R.color.container_fastscroll_thumb_inactive_color));
        mThumbActiveColor = res.getColor(com.watsonh.fractlauncher.R.color.container_fastscroll_thumb_active_color);
        mThumbPaint = new Paint();
        mThumbPaint.setAntiAlias(true);
        mThumbPaint.setColor(mThumbInactiveColor);
        mThumbPaint.setStyle(Paint.Style.FILL);
        mThumbWidth = mThumbMinWidth = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.container_fastscroll_thumb_min_width);
        mThumbMaxWidth = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.container_fastscroll_thumb_max_width);
        mThumbHeight = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.container_fastscroll_thumb_height);
        mThumbCurvature = mThumbMaxWidth - mThumbMinWidth;
        mTouchInset = res.getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.container_fastscroll_thumb_touch_inset);
    }
