...
public class PendingAppWidgetHostView extends LauncherAppWidgetHostView implements OnClickListener {
    ...
    public PendingAppWidgetHostView(Context context, LauncherAppWidgetInfo info,
        ...
        setBackgroundResource(com.watsonh.fractlauncher.R.drawable.quantum_panel_dark);
        setWillNotDraw(false);

        if (Utilities.ATLEAST_LOLLIPOP) {
            setElevation(getResources().getDimension(com.watsonh.fractlauncher.R.dimen.pending_widget_elevation));
        }
    }
    ...
    protected View getDefaultView() {
        if (mDefaultView == null) {
            mDefaultView = mInflater.inflate(com.watsonh.fractlauncher.R.layout.appwidget_not_ready, this, false);
    ...
    public void updateIcon(IconCache cache) {
        ...
        if (mIcon != null) {
            ...
            if (mDisabledForSafeMode) {
                ...
                mSettingIconDrawable = getResources().getDrawable(com.watsonh.fractlauncher.R.drawable.ic_setting).mutate();

                updateSettingColor();
            } else {
                if (sPreloaderTheme == null) {
                    sPreloaderTheme = getResources().newTheme();
                    sPreloaderTheme.applyStyle(com.watsonh.fractlauncher.R.style.PreloadIcon, true);
                }
    ...
    private void updateDrawableBounds() {
        ...
        int minPadding = getResources()
                .getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.pending_widget_min_padding);
        ...
        if (mSettingIconDrawable == null) {
            ...
            mSetupTextLayout = new StaticLayout(
                    getResources().getText(com.watsonh.fractlauncher.R.string.gadget_setup_text), mPaint, availableWidth,
