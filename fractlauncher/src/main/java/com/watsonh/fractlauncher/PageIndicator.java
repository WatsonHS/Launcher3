...
public class PageIndicator extends LinearLayout {
    ...
    public static class PageMarkerResources {
        ...
        public PageMarkerResources() {
            activeId = com.watsonh.fractlauncher.R.drawable.ic_pageindicator_current;
            inactiveId = com.watsonh.fractlauncher.R.drawable.ic_pageindicator_default;
        }
    ...
    public PageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                com.watsonh.fractlauncher.R.styleable.PageIndicator, defStyle, 0);
        mMaxWindowSize = a.getInteger(com.watsonh.fractlauncher.R.styleable.PageIndicator_windowSize, 15);
        mWindowRange[0] = 0;
        mWindowRange[1] = 0;
    ...
    void addMarker(int index, PageMarkerResources marker, boolean allowAnimations) {
        ...
        PageIndicatorMarker m =
            (PageIndicatorMarker) mLayoutInflater.inflate(com.watsonh.fractlauncher.R.layout.page_indicator_marker,
                    this, false);
