...
import com.watsonh.fractlauncher.widget.WidgetCell;
...
public class WidgetPreviewLoader {
    ...
    public WidgetPreviewLoader(Context context, IconCache iconCache) {
        ...
        mProfileBadgeMargin = context.getResources()
                .getDimensionPixelSize(com.watsonh.fractlauncher.R.dimen.profile_badge_margin);
    }
    ...
    public Bitmap generateWidgetPreview(Launcher launcher, LauncherAppWidgetProviderInfo info,
        ...
        if (widgetPreviewExists) {
            ...
            tileBitmap = ((BitmapDrawable) mContext.getResources().getDrawable(
                    com.watsonh.fractlauncher.R.drawable.widget_tile)).getBitmap();
    ...
    private Bitmap generateShortcutPreview(
        ...
        int paddingTop = res.getDimensionPixelOffset(com.watsonh.fractlauncher.R.dimen.shortcut_preview_padding_top);
        int paddingLeft = res.getDimensionPixelOffset(com.watsonh.fractlauncher.R.dimen.shortcut_preview_padding_left);
        int paddingRight = res.getDimensionPixelOffset(com.watsonh.fractlauncher.R.dimen.shortcut_preview_padding_right);
